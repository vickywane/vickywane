...
const style = {
  body: "text-xs md:text-sm lg:text-base text-neutral-gray font-roboto-flex tracking-wider",
  span: "italic",
...
export const Typography = ({ as, children, styleAs, className }: TypographyProps) => {
  const Text = as ?? "p"
