    ...
    <Layout>
      ...
      <Body article>
        <section>
          ...
          <Text article>
            Simply put, it is a way to host stateless containers and it takes a
            way infrastructure management such as [[[]]]. It supports any
          ...
          <Text article>
            ...
            how to deploy local images to the container registry using the cloud
            sdk . [[]] I used docker-compose to build the images into
            multi-stage containers and here is a copy of my dockerfile; Also my
            docker-compose.yml
          </Text>
