...
import { Article, Engagement, Homepage, Notification, WorkExperience } from "@/data/schema";
import BreadcrumbMenu from "@/components/headers/BreadcrumbMenu";
...
export default function Home({ pageData: data }: HomeProps) {
  return (
    ...
    >
      ...
      <HomeHeroNotification notification={data?.notifications[0] as unknown as Notification} />
      ...
      <FeaturedTravelInsight articles={data?.articles as unknown as Article[]} />

      <JobSummary experiences={data?.experiences as unknown as WorkExperience[]} />

      <ProjectsSummary />

      <TechnicalArticleSummary articles={data?.articles as unknown as Article[]} />

      <TalkSummary engagements={data?.engagements as unknown as Engagement[]} />
      <Footer />
    </main>
  );
}
